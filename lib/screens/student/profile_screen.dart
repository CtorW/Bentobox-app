      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            _infoRow('Student ID', user?['id'] ?? 'N/A'),
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text(
              'Your account is secured. You can change your password from the login screen using "Forgot Password".',
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('📧 Email: lome.isidoro.sjc@phinmaed.com'),
            SizedBox(height: 8),
            Text('📧 dary.paano.sjc@phinmaed.com'),
            SizedBox(height: 8),
            Text('📞 Phone: 09859808713'),
            SizedBox(height: 8),
            Text('🏫 Visit: DH 501'),
            SizedBox(height: 16),
            Text(
              'For canteen-related concerns, please visit the canteen admin office.',
            ),
          ],
        ),
        actions: [
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(Icons.restaurant, size: 48, color: Color(0xFF4b652a)),
            SizedBox(height: 16),
            Text(
              'BENTOBOX Canteen App',
