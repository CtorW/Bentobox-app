...
class _NotificationsScreenState extends State<NotificationsScreen>
  ...
  List<Map<String, dynamic>> _getFilteredNotifications(int tabIndex) {
    final all = MockDatabase().notifications;
    switch (tabIndex) {
      case 1:
        ...
        builder: (context, snapshot) {
          return TabBarView(
            ...
            children: _tabs.asMap().entries.map((entry) {
              final notifications = _getFilteredNotifications(entry.key);
  ...
  Widget _buildNotificationCard(Map<String, dynamic> notif) {
    ...
    return Dismissible(
      ...
      onDismissed: (_) {
        MockDatabase().notifications.removeWhere((n) => n['id'] == notif['id']);
        setState(() {});
      },
      child: GestureDetector(
        onTap: () {
          MockDatabase().markNotificationRead(notif['id']);
          setState(() {});
        },
